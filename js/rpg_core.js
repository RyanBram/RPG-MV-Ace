 ...
 * @final
 */
Utils.RPGMAKER_VERSION = "Community 1.5";

Utils.RPGMAKER_ENGINE = "Pixi v5";
...
/**
 * @method _createSourceNode
 * @param {Object} chunk
 * @private
 */
WebAudio.prototype._createSourceNode = function (chunk) {
    if (!this.isPlaying() || !chunk || !this._gainNode) {
        return;
    }
    if (chunk.sourceNode) {
...
/**
 * Decrypts a Uint8Array for streaming audio
 *
 * @static
 * @method decryptUint8Array
 * @param {Uint8Array} uint8Array - The encrypted Uint8Array
...
/**
 * Fetch with retry for streaming support
 *
 * @static
 * @method fetchWithRetry
 * @param {String} method - The fetch method (stream, arrayBuffer, blob, etc.)
