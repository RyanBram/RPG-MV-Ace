...
Window_EquipItem.prototype.makeItemList = function () {
    ...
    // Move null item (unequip option) to the front
...
Window_EquipItem.prototype.drawItem = function (index) {
    ...
    if (!item && this._actor && this._slotId >= 0) {
        // Draw "Remove" text for unequip slot
        var rect = this.itemRect(index);
        rect.width -= this.textPadding();
        this.changePaintOpacity(true);
        this.drawText("Remove", rect.x + 36, rect.y, rect.width - 36);
        this.changePaintOpacity(true);
    } else {
...
Window_SavefileList.prototype.drawFileId = function (id, x, y) {
    if (DataManager.isAutoSaveFileId(id)) {
        ...
        var displayId = DataManager._autoSaveFileId !== 0 ? id - 1 : id;
        this.drawText(TextManager.file + " " + displayId, x, y, 180);
    }
};
