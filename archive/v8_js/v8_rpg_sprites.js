//=============================================================================
// rpg_sprites.js - community-3.0 (pixi v8)
...
Sprite_Character.prototype.updateBitmap = function () {
  ...
  // [V8 Fix] Hide sprite until bitmap is ready to prevent screen flicker
...
Sprite_Picture.prototype.updateBitmap = function () {
  ...
  if (picture) {
    ...
    // [V8 Fix] Only show sprite when bitmap is ready to prevent screen flicker
    this.visible = this.bitmap && this.bitmap.isReady();
  } else {
    this._pictureName = "";
    this.bitmap = null;
    this.visible = false;
...
Spriteset_Map.prototype.createTilemap = function () {
  ...
  // Console log which tilemap is currently active and which renderer type is in use
  try {
    var rendererType = Graphics.isWebGPU()
      ? "WebGPU"
      : Graphics.isWebGL()
        ? "WebGL"
        : "Canvas";
    var tilemapType =
      typeof ShaderTilemap !== "undefined" &&
      this._tilemap instanceof ShaderTilemap
        ? "ShaderTilemap"
        : "Tilemap";
    console.log("[Tilemap] Renderer:", rendererType, "- Using:", tilemapType);
  } catch (e) {
    // Logging should never block game execution
    console.error("[Tilemap] Error while logging tilemap type:", e);
  }
