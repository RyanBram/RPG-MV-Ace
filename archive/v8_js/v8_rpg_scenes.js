//=============================================================================
// rpg_scenes.js - community-3.0 (pixi v8)
...
Scene_MenuBase.prototype.createBackground = function () {
  ...
  // [V8 FIX] Set anchor ONCE at creation, not in layout update
  this._backgroundSprite.anchor.x = 0.5;
  this._backgroundSprite.anchor.y = 0.5;

  this.addChild(this._backgroundSprite);

  // [V8 FIX] Call layout update immediately to set initial x, y, scale
