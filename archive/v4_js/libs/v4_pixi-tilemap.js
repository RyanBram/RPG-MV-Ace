    ...
    var CompositeRectTileLayer = (function (_super) {
      ...
      CompositeRectTileLayer.prototype.addFrame = function (
        ...
        if (typeof texture_ === "number") {
          ...
          if (!layer) {
            ...
            if (!layer) {
              children.push(
                (layer = new tilemap.RectTileLayer(this.zIndex, texture)),
              );
              ind = 0;
            }
          }
      ...
      CompositeRectTileLayer.prototype.renderWebGL = function (renderer) {
        ...
        var af = (shader.uniforms.animationFrame =
          renderer.plugins.tilemap.tileAnim);
        var layers = this.children;
        for (var i = 0; i < layers.length; i++)
      ...
      function RectTileShader(gl, maxTextures) {
        var _this =
          _super.call(
            ...
            maxTextures,
            rectShaderVert,
            tilemap.shaderGenerator.generateFragmentSrc(
              maxTextures,
              rectShaderFrag,
            ),
          ) || this;
...
(function (PIXI) {
  ...
  (function (tilemap) {
    ...
    (function (shaderGenerator) {
      ...
      (shaderGenerator =
        tilemap.shaderGenerator || (tilemap.shaderGenerator = {})),
    );
  })((tilemap = PIXI.tilemap || (PIXI.tilemap = {})));
})(PIXI || (PIXI = {}));
var PIXI;
