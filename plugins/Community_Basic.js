 ...
 * @option Auto
 * @option Fit
 * @desc Set aspect ratio mode (Auto: Dynamic ratio adjustment, Fit: StretchMode + no ratio adjustment)
 * @default Auto
 *
 * @param Screen Width
 * @type number
 ...
 * @param Use Auto Save
 * @type boolean
 * @desc Enable auto save when "Transfer Player"
 * @on ON
 * @off OFF
 * @default false
 *
...
(function () {
    ...
    var paramUseAutoSave = parameters["Use Auto Save"] === "true" || parameters["Use Auto Save"] === "on";
    ...
    var paramAspectRatio = parameters["Aspect Ratio"] || "Auto";
    ...
    function adjustRatio() {
        // Only apply dynamic ratio adjustment if Aspect Ratio mode is "Auto"
        if (paramAspectRatio.toLowerCase() !== "auto") {
            // Fit mode: Don't adjust ratio dynamically
            return;
        }
    ...
    Graphics.setShowErrorDetail(true);
    ...
    // 464
    DataManager.setAutoSaveFileId(paramUseAutoSave ? 1 : 0);
